...
title @s actionbar [{"text":"Successfully disguised","color":"green"}]
particle happy_villager ~ ~ ~ 0.75 0.5 0.75 0 10 force @s
...
summon armor_stand 29999998 240 -29999964 {NoGravity:1b,Invisible:1b,Small:1b,Invulnerable:1b,Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:bedrock"},NoGravity:1b,Time:-2147483648,Air:-2147483648,Tags:["bh.as"]}]}
