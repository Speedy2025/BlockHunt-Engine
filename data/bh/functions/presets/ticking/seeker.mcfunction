...
execute if score @s bh.blinded matches 1.. run effect give @s slowness 1 128 true
execute if score @s bh.blinded matches 1.. run effect give @s jump_boost 1 128 true
execute if score @s bh.blinded matches 1.. if score #selected_map bh.multi matches 2 run effect give @a[tag=bh.hider] speed 1 0 true
