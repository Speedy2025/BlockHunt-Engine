...
execute as @a[scores={bh.click=1..,bh.cooldown=0},tag=bh.seeker] at @s run function bh:operations/attempt_hit
...
execute as @a at @s run function #bh:api/ticking/all

function bh:operations/check_end